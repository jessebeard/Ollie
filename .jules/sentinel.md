...
## 2026-06-11 - Fix Attribute Injection XSS in Legacy Vault
**Vulnerability:** Attribute Injection (XSS) in Legacy Vault UI
**Learning:** Legacy UI used DOM based innerHTML logic to escape strings which didn't escape quotes.
**Prevention:** Use a native string replacement algorithm for escaping HTML safely which also escapes quotes.
