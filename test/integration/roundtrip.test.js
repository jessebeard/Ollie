...
describe('Encoder-Decoder Roundtrip', () => {
    ...
    it('should roundtrip solid black image', () => {
        const original = createSolidImage(8, 8, 0, 0, 0);
        const encoder = new JpegEncoder();
        const decoder = new JpegDecoder();

        const jpegBytes = encoder.encode(original, 90);
    ...
    it('should roundtrip solid white image', () => {
    ...
    it('should produce acceptable quality at Q=90', () => {
        const original = createGradientImage(16, 16);
        const encoder = new JpegEncoder();
        const decoder = new JpegDecoder();
    ...
    it('should handle different quality settings', () => {
        ...
        const q10 = encoder.encode(original, 10);
        const q50 = encoder.encode(original, 50);
        const q90 = encoder.encode(original, 90);

        const decoded10 = decoder.decode(q10);
        const decoded50 = decoder.decode(q50);
        const decoded90 = decoder.decode(q90);
    ...
    it('should handle edge case 1x1 image', () => {
    ...
    it('should handle 8x8 image (single MCU)', () => {
