...
import { forwardDCT, forwardDCTNaive, forwardDCTAAN } from '../../../src/algebraic/discrete-cosine/forward-dct.js';
...
describe('Discrete Cosine Transform', () => {
    describe('forwardDCT (default/naive)', () => {
        ...
        it('should roundtrip with inverse DCT (IDCT)', async () => {
            const { idctNaive } = await import('../../../src/algebraic/discrete-cosine/inverse-dct.js');
