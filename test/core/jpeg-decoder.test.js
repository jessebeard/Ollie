...
describe('JpegDecoder Integration', async () => {
    ...
    it('should handle different quality settings', async () => {
        ...
        const result10 = await decoder.decode(q10);
        const result90 = await decoder.decode(q90);
    ...
    it('should validate SOI marker', async () => {
        ...
        try {
            await decoder.decode(invalidBytes);
        } catch (e) {
            errorThrown = true;
    ...
    it('should reset state between decodes', async () => {
        ...
        const result1 = await decoder.decode(jpegBytes);
        const result2 = await decoder.decode(jpegBytes);
