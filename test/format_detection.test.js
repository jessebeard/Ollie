...
describe('Jsteg Format Detection', () => {
    ...
    it('should extract legacy format with extract()', async () => {
    ...
    it('should extract container format with extractContainer()', async () => {
    ...
    it('should NOT extract container format with legacy extract()', async () => {
        const blocks = createMockBlocks(200);
        const data = new Uint8Array([10, 20, 30]);
        const metadata = { filename: 'test.bin' };
