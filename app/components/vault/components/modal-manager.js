            ...
            const inputsHtml = fields.map(field => {
                ...
                if (type === 'textarea') {
                    return `
                        <div class="form-group">
                            <label>${this.escape(label)}</label>
                            <textarea name="${field.name}" class="form-control" ${required}>${this.escape(val)}</textarea>
                        </div>`;
                }
                ...
                return `
                    <div class="form-group">
                        <label>${this.escape(label)}</label>
                        <input type="${type}" name="${field.name}" value="${this.escape(val)}" class="form-control" ${required}>
                    </div>`;
            }).join('');
