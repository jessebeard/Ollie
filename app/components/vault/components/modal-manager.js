            ...
            const inputsHtml = fields.map(field => {
                ...
                if (type === 'textarea') {
                    return `
                        <div class="form-group">
                            <label>${this.#escapeHTML(label)}</label>
                            <textarea name="${field.name}" class="form-control" ${required}>${this.#escapeHTML(val)}</textarea>
                        </div>`;
                }
                ...
                return `
                    <div class="form-group">
                        <label>${this.#escapeHTML(label)}</label>
                        <input type="${type}" name="${field.name}" value="${this.#escapeHTML(val)}" class="form-control" ${required}>
                    </div>`;
            }).join('');
