...
export class VaultUI {
    ...
    getVaultSize() {
        ...
        // ⚡ Bolt: Memoize expensive vault serialization against immutable vault reference.
        // This prevents blocking the main thread with JSON.stringify and TextEncoder
        // on every keystroke when filtering the vault list.
        if (this._cachedVaultSizeRef === this.vault) {
        ...
        this._cachedVaultSizeRef = this.vault;
