...
export class VaultUI {
    ...
    getVaultSize() {
        ...
        // ⚡ Bolt: Cache expensive vault serialization. Vault is immutable, so reference equality is safe.
        if (this._lastVaultReference === this.vault) {
        ...
        this._lastVaultReference = this.vault;
        return this._vaultSizeCache;
    }
