...
export class VaultUI {
    ...
    getVaultSize() {
        ...
        // ⚡ Bolt: Cache expensive size derivation against the immutable vault reference to prevent main-thread blocking during UI updates.
        if (this._cachedVaultForSize === this.vault) return this._cachedVaultSize;
