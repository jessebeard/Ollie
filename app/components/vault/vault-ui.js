...
export class VaultUI {
    ...
    getVaultSize() {
        ...
        // Bolt Optimization: Cache expensive JSON serialization and encoding
        // against the immutable vault reference to prevent main thread
        // blocking during frequent UI updates (e.g. search keystrokes).
