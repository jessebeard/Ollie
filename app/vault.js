...
class PasswordVault {
     ...
     */
    search(query) {
        // ⚡ Bolt Optimization: Use a precompiled RegExp for O(N) case-insensitive text matching
        // This avoids repeated .toLowerCase() string allocations inside the .filter() loop
