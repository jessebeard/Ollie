...
class PasswordVault {
     ...
     */
    search(query) {
        // ⚡ Bolt Optimization: Use precompiled case-insensitive RegExp instead of repeated string allocations (.toLowerCase)
        const escapedQuery = query.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
        const searchRegex = query ? new RegExp(escapedQuery, 'i') : null;
