...
class PasswordVault {
    ...
    search(query) {
        ...
        // ⚡ Bolt Optimization: Precompile case-insensitive RegExp outside the filter loop
        // This avoids repeated string allocations from .toLowerCase().includes() per entry
