...
class PasswordVault {
     ...
     */
    search(query) {
        // Bolt: Optimize search by precompiling a case-insensitive RegExp outside the loop
        // to avoid repeated string allocations (toLowerCase().includes()) for O(N) text matching.
