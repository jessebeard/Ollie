...
class PasswordVault {
     ...
     */
    search(query) {
        // ⚡ Bolt Optimization: Use precompiled case-insensitive RegExp instead of repeated .toLowerCase().includes()
        // This avoids creating thousands of temporary lowercase strings during search filters
