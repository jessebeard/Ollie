...
class PasswordVault {
     ...
     */
    search(query) {
        // ⚡ Bolt Optimization: Use precompiled RegExp for case-insensitive text matching
        // This avoids repeated string allocations inside the filter loop.
        const escapedQuery = query ? String(query).replace(/[.*+?^${}()|[\]\\]/g, '\\$&') : '';
