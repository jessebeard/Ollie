...
class PasswordVault {
     ...
     */
    search(query) {
        // ⚡ Bolt Optimization: Use a single precompiled RegExp for O(N) case-insensitive matching
        // This avoids repeated string allocations (.toLowerCase()) during high-frequency vault searches
