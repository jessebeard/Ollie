...
export function computeCategory(val) {
    if (val === 0) return 0;
    // Bolt Optimization: Replace O(log N) bitwise while loop with O(1) hardware instruction
    // Math.clz32. This avoids looping to calculate category and yields significant perf gains in encoder loops.
