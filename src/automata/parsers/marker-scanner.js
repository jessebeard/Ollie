...
export const STANDALONE_MARKERS = new Set([
...
export function readMarkerSegment(data, offset) {
    ...
    // ⚡ Bolt: Using a Set lookup here to avoid repeated array allocations
    // and O(N) .includes() checks in the hot path of segment reading.
