...
export class PasswordVault {
    ...
    search(query, tags = []) {
        // ⚡ Bolt Optimization: Use precompiled case-insensitive RegExp instead of repeated .toLowerCase() and .includes()
        ...
        return this.entries.filter(e => {
            ...
            const matchesTags = tags.length === 0 || tags.every(tag => e.tags && e.tags.includes(tag));
