...
export function componentsToImageData(yData, cbData, crData, width, height) {
    ...
    for (let i = 0; i < width * height; i++) {
        ...
        const offset = i * 4;
        // Uint8ClampedArray natively handles [0, 255] clamping and rounding
        // Eliminating explicit Math.* calls significantly reduces function call overhead in hot loops
