...
export function componentsToImageData(yData, cbData, crData, width, height) {
    ...
    for (let i = 0; i < width * height; i++) {
        ...
        const offset = i * 4;
        // Optimization: Uint8ClampedArray handles clamping [0, 255] and rounding natively.
        // Avoiding Math.max/min/round here saves significant overhead in this hot loop.
